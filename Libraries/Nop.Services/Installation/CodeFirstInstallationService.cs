...
using Nop.Core.Data;
using Nop.Domain;
//using Nop.Domain.Affiliates;
//using Nop.Domain.Blogs;
//using Nop.Domain.Catalog;
//using Nop.Domain.Cms;
using Nop.Domain.Common;
//using Nop.Domain.Customers;
//using Nop.Domain.Directory;
//using Nop.Domain.Discounts;
//using Nop.Domain.Forums;
using Nop.Domain.Localization;
using Nop.Domain.Logging;
//using Nop.Domain.Media;
//using Nop.Domain.Messages;
//using Nop.Domain.News;
//using Nop.Domain.Orders;
//using Nop.Domain.Payments;
//using Nop.Domain.Polls;
using Nop.Domain.Security;
//using Nop.Domain.Seo;
//using Nop.Domain.Shipping;
//using Nop.Domain.Stores;
//using Nop.Domain.Tasks;
//using Nop.Domain.Tax;
//using Nop.Domain.Topics;
//using Nop.Domain.Vendors;
